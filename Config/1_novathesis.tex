...
\ntsetup{doctype=phd}       % The type of document
%                               %     [     phd —> PhD thesis
...
\ntsetup{docstatus=working}     % The status of the document TODO: change this! 
...
% \ntsetup{cover/color=green}   % Only effective for NOVA/ITQB {gray/green}
