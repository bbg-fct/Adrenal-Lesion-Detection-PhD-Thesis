...
\nttitle(main,en){Adrenal Lesion Detection in MRI with Deep Learning \\ - CHANGE IT}%
...
%-------------------------------------------------------------------
\ntauthorname(m){Bernardo Brás Gonçalves}{Bernardo Gonçalves}

%-------------------------------------------------------------------
% AUTHOR previous degree
% SYNTAX: \ntauthordegree{degree}
%-------------------------------------------------------------------
\ntauthordegree(en){Master in Biomedical Engineering}
\ntauthordegree(pt){Mestrado em Engenharia Biomédica}
